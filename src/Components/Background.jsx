    ...
    <div className='background-container'>
      ...
      <p id='background-description'>
        ...
        <div id='second-description'>
          <div>
            <strong>Fun fact:</strong> When I'm not coding, you'll find me
            diving into the world of lawn care - determined to have the best
            lawn in the neighborhood. It's my little green oasis project beyond
            the keyboard.
          </div>
          <img src='../../images/lawn.jpg' alt='lawn' id='lawn-img' />
        </div>
